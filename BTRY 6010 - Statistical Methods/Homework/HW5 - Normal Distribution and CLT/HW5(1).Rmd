...
```{r}
hist(x4mean_realizations, freq=FALSE, main="Histogram of 10,000 draws of the mean of 4 independent poisson experiments")
```  
...
hist(x3mean_realizations, freq=FALSE, main="Histogram of 10,000 draws of the mean of 3 independent poisson experiments")
xvalues = seq(0,2,.01)
yvalues = dnorm(xvalues,.5, sqrt(0.5/n)) 
lines(xvalues,yvalues)
```
...
hist(x10mean_realizations, freq=FALSE, main="Histogram of 10,000 draws of the mean of 10 independent poisson experiments")
xvalues = seq(0,2,.01)
yvalues = dnorm(xvalues,.5, sqrt(0.5/n)) 
lines(xvalues,yvalues)
```
...
hist(x30mean_realizations, freq=FALSE, main="Histogram of 10,000 draws of the mean of 30 independent poisson experiments")
xvalues = seq(0,2,.01)
yvalues = dnorm(xvalues,.5, sqrt(0.5/n)) 
lines(xvalues,yvalues)
```
...
hist(x50mean_realizations, freq=FALSE, main="Histogram of 10,000 draws of the mean of 50 independent poisson experiments")
xvalues = seq(0,2,.01)
yvalues = dnorm(xvalues,.5, sqrt(0.5/n)) 
lines(xvalues,yvalues)
```
