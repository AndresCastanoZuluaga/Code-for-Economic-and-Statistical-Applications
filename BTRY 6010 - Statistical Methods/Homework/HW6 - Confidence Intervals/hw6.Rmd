...
Our 95% confidence interval is (0.746 , 0.8735). Which means that we are 95% confident that the population mean for radar echo duration is between 0.746 and 0.8735.
...
Our 99% confidence interval is (0.726 , 0.893). Which means that we are 99% confident that the true proportion of patient who lived after being admitted to the ICU is between 0.726 and 0.893.
...
Our 95% confidence interval is (8.066 , 8.893). Which means that we are 95% confident that the true mean of the proportional limit stress of the specimens is between 0.726 MPa and 0.893 MPa.
...
If the confidence interval is set to a 90% the quantile of the normal standard distribution will be greater, then the lower bound of the interval is going to decrease  and upper bound of the interval is going to increase, which ultimately leads to a less precise confidence interval (wider), in common words we are less sure about if our interval will contain the true population mean compared to the case with 95% confidence.     
