...
The increase of nx improve the power of the test. 
...
When both nx and ny increase, the power of the test increases greater than only nx is changes.
...
The power of the test increases when we are interested in identified a greater effect size.
